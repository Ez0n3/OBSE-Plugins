...
This mirror of the SDK is currently set to support Oblivion runtime: **1.2.26.0 (0x010201A0)** - OBSE build: **0.0.21.4**, other versions will need to be manually configured.  
