...
#define PLUGIN_NAME_SHORT			"ez_obse_plugin_example"	// Plugin name without spaces
#define PLUGIN_NAME_LONG			"Ez OBSE Plugin Example"	// Plugin name with spaces
...
#define MINIMUM_RUNTIME_VERSION				OBLIVION_VERSION_0_1	// The lowest version
